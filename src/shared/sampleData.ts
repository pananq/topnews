...
export const SAMPLE_LATEST_NEWS: LatestNews = {
  ...
  events: [
    ...
    event(4, "财经", "全球市场关注主要央行最新利率信号", "金融媒体集中报道了主要央行对通胀和利率路径的最新表态。投资者正在重新定价债券、股票和外汇市场风险。", ["全球"], 83),
    ...
    event(9, "财经", "主要经济体公布新一批制造业与消费数据", "经济数据成为市场和政策讨论焦点。分析师关注消费韧性、制造业订单和就业市场变化。", ["全球"], 66),
